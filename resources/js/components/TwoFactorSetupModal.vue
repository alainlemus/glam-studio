...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación de dos factores ya está habilitada. Escanea el código QR o ingresa la clave de configuración en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de habilitar la autenticación de dos factores, escanea el código QR o ingresa la clave de configuración en tu app de autenticación',
        buttonText: 'Continuar',
    };
});
