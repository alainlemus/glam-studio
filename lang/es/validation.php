...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Language Lines de Validación
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas contienen los mensajes de error por defecto
    | usados por la clase Validator. Algunas de estas reglas tienen
    | múltiples versiones, como las reglas de tamaño.
    |
    */
    ...
    */
    ...
    'attributes' => [
        'name' => 'nombre',
        'client_name' => 'nombre de la clienta',
        ...
        'tagline' => 'tagline',
        'footer_description' => 'descripción del footer',
